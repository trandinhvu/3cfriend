...
playState.init = function() {
    ...
    function t() {
        0 == Sound.slave ? (Sound.setMute(!1), e.muteButtonPU.setFrames(1, 0, 1, 0), window.famobi_analytics.trackEvent(famobi_analytics.EVENT_VOLUMECHANGE, {
            bgmVolume: 0,
            sfxVolume: 1
        })) : (Sound.setMute(!0), e.muteButtonPU.setFrames(3, 2, 3, 2), window.famobi_analytics.trackEvent(famobi_analytics.EVENT_VOLUMECHANGE, {
            bgmVolume: 0,
            sfxVolume: 0
        })), playState.resumeGame()
    }
    ...
    function n() {
        1 != e.foulWindow.visible && 0 == e.gameOver && (window.famobi_analytics.trackScreen("SCREEN_PAUSE"), e.gameRunning = !1, e.popUpPanel.visible = !0, e.quitButtonPU.input.enabled = !0, e.replayButtonPU.input.enabled = !0, e.playButtonPU.input.enabled = !0, e.muteButtonPU.input.enabled = !0)
    }

    function r() {
        game.add.tween(e.guiCanvas).to({
            alpha: 0
        }, 1e3, Phaser.Easing.Linear.None, !0), game.add.tween(e.guiBaseCanvas).to({
            alpha: 0
        }, 1e3, Phaser.Easing.Linear.None, !0);
        game.add.tween(e.gameCanvas).to({
            alpha: 0
        }, 1e3, Phaser.Easing.Linear.None, !0).onComplete.add((function() {
    ...
    function o() {
        projectInfo.lastBreaker = "none", e.gameOver ? window.famobi_analytics.trackEvent("EVENT_LEVELRESTART", {
            levelName: projectInfo.levelName
        }).then((function() {
    ...
    e.adjustmentScale = 2.3, e.settingSpin = !1, e.pointerStartL = new Point(-850, -200), e.pointerStartP = new Point(100, -450), e.pointerEndL = new Point(-850, -50), e.pointerEndP = new Point(-80, -450), e.pointerProgress = 0, e.numLevels = 6, e.ballRadius = 1e3 * e.adjustmentScale, e.physScale = .01, e.friction = 1.5, e.gameOver = !1, e.counter = 0, e.transferCounter = 0, e.bonusStarOn = !1, e.starNumber = 2, e.timerStarted = !1, e.ballPotted = !1, e.ballsPotted = 0, e.fouled = !1, e.multiplier = 1, e.frictionSpeedThreshold = 85, e.pocketRadius = 2250, e.minVelocity = 2, e.cushionRestitution = .6, e.ballRestitution = .94, e.maxPower = 5e3, e.trial = !1, e.overlap = !1, e.cueBallInHand = !0, e.preventAim = !1, e.preventSetPower = !1, e.preventUpdateCue = !1, e.cueSet = !1, e.shotRunning = !1, e.settingPower = !1, e.executeStrike = !1, e.beginStrike = !1, e.cueTweenComplete = !1, e.firstTouch = !1, e.tutStage = 0, e.shotComplete = !1, e.rulingsApplied = !1, e.shotNum = 0, e.scratched = !1, e.trial = !1, e.pottedBallArray = new Array, e.time = 0, e.scratchFoulShown = !1, e.p1TargetType = "ANY", e.p2TargetType = "ANY", e.scratch = !1, e.foulMessage = "", e.shotNum = 0, e.turnExtended = !1, e.ballsPottedSameType = !1, e.typesPotted = "", e.trial = !1, e.initVars = !1, e.shotReset = !0, e.drawGuide = !0, e.allowTransferPoints = !1, e.placedInCenter = !1, e.foulDisplayComplete = !0, e.transfer1Complete = !0, e.transfer2Complete = !0, e.aimDirectionVector = new Vector2D(1, 0).normalize(),
        function() {
            0 == projectInfo.levelComplete ? projectInfo.level = 1 : projectInfo.level++;
            0 == projectInfo.tutorial && window.famobi_analytics.trackScreen("SCREEN_LEVEL")
        }(),
        function() {
            0 == projectInfo.levelComplete ? projectInfo.score = 0 : projectInfo.levelComplete = !1;
        ...
        function() {
            ...
            for (var t = 0; t < e.numBalls; t++) {
                ...
                n.mc = new Ball(e.ballRadius * e.physScale, t), e.ballCanvas.add(n.mc), 0 == t && (n.mover = new Phaser.Sprite(game, 0, 0, "mover"), e.ballCanvas.add(n.mover), n.mover.anchor = new Point(.5, .5), n.mover.inputEnabled = !0, n.mover.visible = !1), t < 8 && 0 != t && (n.targetType = "SOLIDS"), t > 8 && (n.targetType = "STRIPES"), 8 == t && (n.targetType = "8 BALL"), n.position = new Vector2D(a[t].x, a[t].y), n.velocity = new Vector2D(0, 0), n.lastCollisionObject = null, n.id = t, n.active = !0, n.firstContact = !1, n.contactArray = new Array, 0 == t && (n.screw = 0, n.english = 0, n.deltaScrew = new Vector2D(0, 0)), n.grip = 1, n.ySpin = 0, n.pocketTweenComplete = !0, n.propelling = !1, e.ballArray.push(n)
            }
        }(), e.guide = new Phaser.Graphics(game), e.guideCanvas.addChild(e.guide),
        function() {
            e.debugText = new Phaser.BitmapText(game, game.width - 1, 20, "font7", "", 34), e.guiCanvas.addChild(e.debugText), e.debugText.anchor.x = 1, e.debugText.visible = !1, e.spinSetter = new Phaser.Sprite(game, 0, 0, "spinSetterSmall"), e.guiCanvas.addChild(e.spinSetter), e.spinSetter.anchor = new Point(.5, .5), e.spinSetter.inputEnabled = !0, e.spinSetter.ignoreChildInput = !0, e.cueBallSpot = new Phaser.Sprite(game, 0, 0, "cueBallSpot"), e.spinSetter.addChild(e.cueBallSpot), e.cueBallSpot.anchor = new Point(.5, .5), e.spinSetterZoom = new Phaser.Sprite(game, 0, 0, "spinSetterZoom"), e.guiCanvas.addChild(e.spinSetterZoom), e.spinSetterZoom.anchor = new Point(.5, .5), e.spinSetterZoom.inputEnabled = !0, e.spinSetterZoom.ignoreChildInput = !0, e.cueBallSpotZoom = new Phaser.Sprite(game, 0, 0, "cueBallSpotZoom"), e.spinSetterZoom.addChild(e.cueBallSpotZoom), e.cueBallSpotZoom.anchor = new Point(.5, .5), e.spinSetterZoom.visible = !1, e.rackSolids = new Phaser.Group(game, e.guiCanvas, "rackSolids"), e.rackBGSolids = new Phaser.Sprite(game, 0, 0, "rackBG"), e.rackSolids.addChild(e.rackBGSolids), e.rackBGSolids.x = 1, e.rackBGSolids.y = 0, e.rackBGSolids.anchor = new Point(.5, 1), e.rackSolidsArray = new Array, e.rackSpotNumberArray = new Array;
            for (var i = 0; i < 7; i++) e.rackSolidsArray[i] = new Phaser.Sprite(game, 0, 0, "guiSolids", i), e.rackSolids.addChild(e.rackSolidsArray[i]), e.rackSolidsArray[i].x = 50 * i - 200, e.rackSolidsArray[i].y = 7, e.rackSolidsArray[i].anchor = new Point(0, 1), e.rackSolidsArray[i].visible = !1, e.rackSpotNumberArray[i + 1] = e.rackSolidsArray[i];
            e.rackSolids8ball = new Phaser.Sprite(game, 0, 0, "8ball"), e.rackSolids.addChild(e.rackSolids8ball), e.rackSolids8ball.x = -185, e.rackSolids8ball.y = -11, e.rackSolids8ball.anchor = new Point(0, 1), e.rackSolids8ball.visible = !1, e.rackStripes = new Phaser.Group(game, e.guiCanvas, "rackStripes"), e.rackBGStripes = new Phaser.Sprite(game, 0, 0, "rackBG"), e.rackStripes.addChild(e.rackBGStripes), e.rackBGStripes.x = 1, e.rackBGStripes.y = 0, e.rackBGStripes.anchor = new Point(.5, 1), e.rackStripesArray = new Array;
            for (i = 0; i < 7; i++) {
                e.rackStripesArray[i] = new Phaser.Sprite(game, 0, 0, "guiStripes", i), e.rackStripes.addChild(e.rackStripesArray[i]), e.rackStripesArray[i].x = 50 * i - 200, e.rackStripesArray[i].y = 7, e.rackStripesArray[i].anchor = new Point(0, 1), e.rackStripesArray[i].visible = !1, e.rackSpotNumberArray[i + 9] = e.rackStripesArray[i]
            }
            if (e.rackStripes8ball = new Phaser.Sprite(game, 0, 0, "8ball"), e.rackStripes.addChild(e.rackStripes8ball), e.rackStripes8ball.x = -185, e.rackStripes8ball.y = -11, e.rackStripes8ball.anchor = new Point(0, 1), e.rackStripes8ball.visible = !1, e.turnArrow1 = new Phaser.Sprite(game, 0, 0, "turnArrow"), e.guiCanvas.addChild(e.turnArrow1), e.turnArrow1.anchor = new Point(.5, 1), e.turnArrow1.scale = new Point(.5, .5), e.turnArrow2 = new Phaser.Sprite(game, 0, 0, "turnArrow"), e.guiCanvas.addChild(e.turnArrow2), e.turnArrow2.anchor = new Point(.5, 1), e.turnArrow2.scale = new Point(-.5, .5), e.humanIcon = new Phaser.Sprite(game, 0, 0, "humanIcon"), 2 == projectInfo.mode) {
                (l = new Phaser.BitmapText(game, 124, -(e.humanIcon.height - 204), "font7", "1", 80)).anchor = new Phaser.Point(.5, .5), l.tint = 0, e.humanIcon.addChild(l)
            }
            if (e.guiCanvas.addChild(e.humanIcon), e.humanIcon.anchor = new Point(0, 1), e.humanIcon.scale = new Point(.5, .5), 1 == projectInfo.mode) e.aiIcon = new Phaser.Sprite(game, 0, 0, "aiIcon");
            else {
                e.aiIcon = new Phaser.Sprite(game, 0, 0, "humanIcon"), (c = new Phaser.BitmapText(game, 124, -(e.humanIcon.height - 81), "font7", "2", 80)).anchor = new Phaser.Point(.5, .5), c.tint = 0, e.aiIcon.addChild(c)
            }
            e.guiCanvas.addChild(e.aiIcon), e.aiIcon.anchor = new Point(1, 1), e.aiIcon.scale = new Point(.5, .5), e.guiPanel1 = new Phaser.Sprite(game, 0, 0, "guiPanel1"), e.guiBaseCanvas.addChild(e.guiPanel1), e.guiPanel1.anchor.x = 1, e.guiPanel1.anchor.y = 1, e.guiPanel2 = new Phaser.Sprite(game, 0, 0, "guiPanel1"), e.guiBaseCanvas.addChild(e.guiPanel2), e.guiPanel2.anchor.x = .5, e.guiPanel2.anchor.y = 1, e.guiPanel3 = new Phaser.Sprite(game, 0, 0, "guiPanel1"), e.guiBaseCanvas.addChild(e.guiPanel3), e.guiPanel3.anchor.x = 0, e.guiPanel3.anchor.y = 1, e.timerText = new Phaser.BitmapText(game, 0, 0, "font7", "0:00", 56), e.guiCanvas.addChild(e.timerText), e.timerText.anchor.x = .5, e.timerText.anchor.y = 1, window.gi = e, e.scoreText = new Phaser.BitmapText(game, 0, 0, "font7", projectInfo.score, 56), e.guiCanvas.addChild(e.scoreText), e.scoreText.anchor.x = .5, e.scoreText.anchor.y = 1, e.multiplierText = new Phaser.BitmapText(game, 0, 0, "font7", "x" + e.multiplier, 56), e.guiCanvas.addChild(e.multiplierText), e.multiplierText.anchor.x = .5, e.multiplierText.anchor.y = 1, 2 == projectInfo.mode && (e.timerText.visible = !1, e.scoreText.visible = !1, e.multiplierText.visible = !1);
            e.menuButton = new Phaser.Button(game, 0, 0, "menuButton", n, this, 1, 0, 1), e.menuButton.scale = new Phaser.Point(.5, .5), e.guiCanvas.addChild(e.menuButton), e.menuButton.anchor = new Phaser.Point(.5, 0), game.device.touch && (e.powerBar = new Phaser.Group(game, e.guiCanvas, "powerBar"), e.powerBarBG = new Phaser.Sprite(game, 0, 0, "powerBarBG"), e.powerBarBG.anchor = new Point(.5, .5), e.powerBar.addChild(e.powerBarBG), e.powerBarBase = new Phaser.Sprite(game, 0, -13, "powerBarBase"), e.powerBarBase.anchor = new Point(.5, .5), e.powerBar.addChild(e.powerBarBase), e.powerBarMask = game.add.graphics(e.powerBar.x, e.powerBar.y), e.powerBarBase.mask = e.powerBarMask, e.powerBarTop = new Phaser.Sprite(game, 0, -13, "powerBarTop"), e.powerBarTop.anchor = new Point(.5, .5), e.powerBar.addChild(e.powerBarTop), e.powerBarCue = new Phaser.Sprite(game, 250, 13, "cue"), e.powerBar.addChild(e.powerBarCue), e.powerBarCue.anchor = new Point(1, .5), e.powerBarCueMask = game.add.graphics(e.powerBar.x, e.powerBar.y), e.powerBarCue.mask = e.powerBarCueMask);
            e.gameOverPanel = new Phaser.Group(game, e.guiCanvas, "gameOverPanel"), e.gameOverPanel.anchor = new Point(.5, .5), e.gameOverPanel.visible = !1, e.gameOverPanelBG = new Phaser.Sprite(game, 0, 0, "panel3"), e.gameOverPanelBG.anchor = new Point(.5, .5), e.gameOverPanel.addChild(e.gameOverPanelBG), e.gameOverWindow = new Phaser.Sprite(game, -180, -201, "guiPanel2"), e.gameOverPanel.addChild(e.gameOverWindow), e.aiWin = new Phaser.Sprite(game, 0, 0, "aiWin"), e.aiWin.scale = new Phaser.Point(.5, .5), e.aiWin.anchor = new Phaser.Point(.6, .6), e.gameOverPanel.addChild(e.aiWin), e.aiWin.visible = !1, e.playerWin = new Phaser.Sprite(game, 0, 0, "playerWin"), e.playerWin.scale = new Phaser.Point(.5, .5), e.playerWin.anchor = new Phaser.Point(0, 0), e.gameOverPanel.addChild(e.playerWin), e.playerWin.visible = !1, e.GOscoreIcon = new Phaser.Sprite(game, -78, -180, "score"), e.GOscoreIcon.anchor = new Phaser.Point(.5, .1), e.GOscoreIcon.scale = new Phaser.Point(.45, .45), e.gameOverPanel.addChild(e.GOscoreIcon), e.GOhighScoreIcon = new Phaser.Sprite(game, 270, -256, "highScore"), e.GOhighScoreIcon.anchor = new Phaser.Point(.5, .25), e.GOhighScoreIcon.scale = new Phaser.Point(.5, .5), e.gameOverPanel.addChild(e.GOhighScoreIcon), e.GOaiLevel = new Phaser.Sprite(game, 70, -5, "aiLevel"), e.GOaiLevel.anchor = new Phaser.Point(.5, .5), e.GOaiLevel.scale = new Phaser.Point(.8, .8), e.gameOverPanel.addChild(e.GOaiLevel), e.GOclockIcon = new Phaser.Sprite(game, -180, -5, "clockIcon"), e.GOclockIcon.anchor = new Phaser.Point(.5, .5), e.GOclockIcon.scale = new Phaser.Point(.55, .55), e.gameOverPanel.addChild(e.GOclockIcon);
            let s = {
                x: -140,
                y: -120
            };
            var l;
            e.p1Icon = new Phaser.Sprite(game, s.x, s.y, "humanIcon"), e.p1Icon.anchor = new Phaser.Point(.5, .5), e.p1Icon.scale = new Phaser.Point(.5, .5), e.gameOverPanel.addChild(e.p1Icon), (l = new Phaser.BitmapText(game, -4, 81, "font7", "1", 80)).anchor = new Phaser.Point(.5, .5), l.tint = 0, e.p1Icon.addChild(l), (u = new Phaser.Sprite(game, -128, -128, "rosette")).anchor = new Phaser.Point(.5, .5), u.scale = new Phaser.Point(1, 1), e.p1Icon.addChild(u), e.p1Icon.rosette = u, e.p1Icon.visible = !1;
            let p = {
                x: 140,
                y: -120
            };
            var c, u;
            e.p2Icon = new Phaser.Sprite(game, p.x, p.y, "humanIcon"), e.p2Icon.anchor = new Phaser.Point(.5, .5), e.p2Icon.scale = new Phaser.Point(.5, .5), e.gameOverPanel.addChild(e.p2Icon), (c = new Phaser.BitmapText(game, -4, 81, "font7", "2", 80)).anchor = new Phaser.Point(.5, .5), c.tint = 0, e.p2Icon.addChild(c), (u = new Phaser.Sprite(game, -128, -128, "rosette")).anchor = new Phaser.Point(.5, .5), u.scale = new Phaser.Point(1, 1), e.p2Icon.addChild(u), e.p2Icon.rosette = u, e.p2Icon.visible = !1, e.gameOverPanel.text1 = new Phaser.BitmapText(game, 0, -180, "font7", "xxx", 56), e.gameOverPanel.text2 = new Phaser.BitmapText(game, 0, -209, "font7", "xxx", 56), e.gameOverPanel.text3 = new Phaser.BitmapText(game, -110, -28, "font7", "xxx", 56), e.gameOverPanel.text4 = new Phaser.BitmapText(game, 135, -28, "font7", "xxx", 56), e.gameOverPanel.addChild(e.gameOverPanel.text1), e.gameOverPanel.addChild(e.gameOverPanel.text2), e.gameOverPanel.addChild(e.gameOverPanel.text3), e.gameOverPanel.addChild(e.gameOverPanel.text4);
            e.quitButton2 = new Phaser.Button(game, 90, 170, "quitButton", r, this, 1, 0, 1), e.quitButton2.anchor = new Phaser.Point(.5, .5), e.quitButton2.scale = new Phaser.Point(.5, .5), e.gameOverPanel.addChild(e.quitButton2), e.replayButton = new Phaser.Button(game, -90, 170, "replayButton", o, this, 1, 0, 1), e.replayButton.anchor = new Phaser.Point(.5, .5), e.replayButton.scale = new Phaser.Point(.5, .5), e.gameOverPanel.addChild(e.replayButton), e.quitButton2.input.enabled = !1, e.replayButton.input.enabled = !1, e.popUpPanel = new Phaser.Group(game, e.guiCanvas, "popUpPanel"), e.popUpPanel.anchor = new Point(.5, .5), e.popUpPanel.visible = !1, e.popUpPanelBG = new Phaser.Sprite(game, 0, 0, "panel2"), e.popUpPanelBG.scale = new Point(.75, 1), e.popUpPanelBG.anchor = new Point(.5, .5), e.popUpPanel.addChild(e.popUpPanelBG), e.playButtonPU = new Phaser.Button(game, 0, 0, "playButton", a, this, 1, 0, 1, 0), e.playButtonPU.scale = new Point(.75, .75), e.popUpPanel.addChild(e.playButtonPU), e.playButtonPU.anchor = new Phaser.Point(.5, .5), e.quitButtonPU = new Phaser.Button(game, -57, 0, "quitButton", r, this, 1, 0, 1, 0), e.popUpPanel.addChild(e.quitButtonPU), e.quitButtonPU.anchor = new Phaser.Point(.5, .5), e.quitButtonPU.scale = new Phaser.Point(.5, .5), e.replayButtonPU = new Phaser.Button(game, -170, 0, "replayButton", o, this, 1, 0, 1, 0), e.popUpPanel.addChild(e.replayButtonPU), e.replayButtonPU.anchor = new Phaser.Point(.5, .5), e.replayButtonPU.scale = new Phaser.Point(.5, .5), e.muteButtonPU = new Phaser.Button(game, 57, 0, "muteButton", t, this, 1, 0, 1, 0), e.popUpPanel.addChild(e.muteButtonPU), e.muteButtonPU.anchor = new Phaser.Point(.5, .5), e.muteButtonPU.scale = new Phaser.Point(.5, .5), 1 == Sound.slave ? e.muteButtonPU.setFrames(1, 0, 1, 0) : e.muteButtonPU.setFrames(3, 2, 3, 2);
            e.quitButtonPU.input.enabled = !1, e.replayButtonPU.input.enabled = !1, e.playButtonPU.input.enabled = !1, e.muteButtonPU.input.enabled = !1, e.muteButtonPU.visible = !famobi.hasFeature("external_mute"), e.foulWindow = new Phaser.Group(game, e.guiCanvas, "foulWindow"), e.foulWindow.visible = !1, e.foulWindow.background = new Phaser.Sprite(game, 0, 0, "foulDisplay"), e.foulWindow.addChild(e.foulWindow.background), e.foulWindow.background.anchor = new Point(.5, .5), e.foulWindow.display1 = new Phaser.Sprite(game, -172, -126, "illegalContacts"), e.foulWindow.addChild(e.foulWindow.display1);
            var h = new Phaser.Sprite(game, e.foulWindow.display1.width / 2, e.foulWindow.display1.height / 2 + 20, "cross");
            h.anchor = new Point(.5, 0), e.foulWindow.display1.addChild(h), e.foulWindow.display2 = new Phaser.Sprite(game, -172, 30, "illegalContacts"), e.foulWindow.addChild(e.foulWindow.display2);
            var d = new Phaser.Sprite(game, e.foulWindow.display2.width / 2, e.foulWindow.display2.height / 2 + 20, "tick");
            d.anchor = new Point(.5, 0), e.foulWindow.display2.addChild(d), e.foulWindow.display3 = new Phaser.Sprite(game, 0, 0, "illegalShots"), e.foulWindow.addChild(e.foulWindow.display3), e.foulWindow.display3.anchor = new Point(.5, .5), e.foulWindow.display4 = new Phaser.Sprite(game, 0, 0, "illegalBreak"), e.foulWindow.addChild(e.foulWindow.display4), e.foulWindow.display4.anchor = new Point(.5, .5), e.foulWindow.highlight = new Phaser.Sprite(game, -262, -237, "foulHighlight"), e.foulWindow.addChild(e.foulWindow.highlight), 1 == projectInfo.tutorial && (game.device.touch, e.menuButton.visible = !1, e.turnArrow1.visible = !1, e.turnArrow2.visible = !1, e.humanIcon.visible = !1, e.aiIcon.visible = !1, e.rackSolids.visible = !1, e.rackStripes.visible = !1, e.spinSetter.visible = !1)
        }(), e.cueShadow = new Phaser.Sprite(game, 0, 0, "cueShadow"), e.cueCanvas.addChild(e.cueShadow), e.cueShadow.anchor = new Point(1, 8 / 53), e.cue = new Phaser.Sprite(game, 0, 0, "cue"), e.cueCanvas.addChild(e.cue), e.cue.anchor = new Point(1, .5),
        function() {
            this.contactEvent = new Phaser.Signal, this.contactEvent.add(onContact, this)
        }(),
        function() {
            e.phys = new billiardPhysics(this.contactEvent, e.ballArray, e.lineArray, e.vertexArray, e.pocketArray, 0), e.phys.friction = e.friction, e.phys.ballRadius = e.ballRadius, e.phys.pocketRadius = e.pocketRadius, e.phys.physScale = e.physScale, e.phys.minVelocity = e.minVelocity, e.phys.cushionRestitution = e.cushionRestitution, e.phys.ballRestitution = e.ballRestitution
        }(), renderScreen(),
        function() {
        ...
        }(), resizeGame(), e.gameRunning = !0
}, playState.resumeGame = function() {
    var e = this.gameInfo;
    1 != e.gameOver && (window.famobi_analytics.trackScreen("SCREEN_LEVEL"), e.gameRunning = !0), e.popUpPanel.visible = !1, e.quitButtonPU.input.enabled = !1, e.replayButtonPU.input.enabled = !1, e.playButtonPU.input.enabled = !1, e.muteButtonPU.input.enabled = !1
