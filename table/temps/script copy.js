...
class BilliardTable {
    ...
    resizeCanvas() {
        ...
        if (containerAspectRatio > tableAspectRatio) {
            ...
            this.canvas.height = Math.min(containerHeight, 768);
            this.canvas.width = this.canvas.height * tableAspectRatio;
        } else {
            // Container is taller, fit to width
            this.canvas.width = Math.min(containerWidth, 1280);
    ...
    render() {
        ...
        console.log('Render complete - all layers drawn');
    }
    ...
    drawDiamonds() {
        ...
        // console.log('=== DIAMOND DEBUG INFO ===');
        // console.log(`Canvas size: ${this.canvas.width} x ${this.canvas.height}`);
        // console.log(`Frame thickness: ${frameThickness}px (${this.realDimensions.frameThickness}m)`);
        // console.log(`Outer margin: ${outerMargin}px (50mm)`);
        // console.log(`Inner margin: ${innerMargin}px (44mm)`);
        // console.log(`Diamond spacing: ${diamondSpacing}px (358.8mm)`);
        // console.log(`Diamond radius: ${diamondSize}px`);
    ...
    drawCircleDiamond(centerX, centerY, radius) {
        ...
        //console.log(`Drew circle diamond at (${centerX}, ${centerY}) with radius ${radius}`);
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Table dimensions:', table.realDimensions);
    console.log('Available themes:', Object.keys(table.themes));
});
